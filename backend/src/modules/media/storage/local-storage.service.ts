...
export class LocalStorageService implements StorageService {
  ...
  async upload(
    ...
    const directory = join(process.cwd(), this.uploadDir, safeFolder);
  ...
  async delete(
    ...
    const safePath = this.sanitizePublicId(publicId);

    const filePath = join(process.cwd(), this.uploadDir, safePath);
