...
export class EventTimelineController {
  ...
  async create(
    ...
    const entry = await this.service.create(organization, eventId, dto);
  ...
  async update(
    ...
    const entry = await this.service.update(organization, eventId, id, dto);
  ...
  async remove(
    ...
    const entry = await this.service.remove(organization, eventId, id);
